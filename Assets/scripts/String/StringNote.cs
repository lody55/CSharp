...
public class StringNote : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(str[5]); //문자 'D' 출력
        Debug.Log(str.ToUpper());   // 대문자로 출력하기
        Debug.Log(str.ToLower());   // 소문자로 출력하기
        ...
        Debug.Log(System.String.Compare("BAC","Bac")); // 리턴값 : 0(같음) , 1(다름, 크기비교 >), -1(다름, 크기비교 <) 
        ...
        Debug.Log(hi + hi2);
        Debug.Log($"{hi}{hi2}");
        Debug.Log(System.String.Format("{0}{1}",hi,hi2));
